...
export const ui = {
  ...
  mirrorBlocks: [
    '原作者认可评论区的镜像地址，其实是一件蛮高风险的事情（别人完全可能会添加引流内容或恶意代码），但原作者愿意信任我，我也应当回报这份信任，以下为网站声明：',
    '本镜像(sbti.unun.dev)除该页面声明和图片拆分以优化加载外，<br>未作任何其它修改，地址直到过期都不会挪作他用，可以放心使用。',
    '原作者并未开源，但仅因网页自身即为全部源码，出于存档目的，你可以在 <a href="https://github.com/UnluckyNinja/SBTI-test" rel="noopener" target="_blank">此处</a> 查看。',
  ],
  mirrorFooter:
    '网站从4月10日中午开始，境内逐渐无法访问。网站自身一切正常，不是流量问题，纯前端网站没有后端，而Cloudflare也是经历过大风大浪的。本站不企图去避开绕过，这只会将情况变得更糟。相信大家都能八仙过海各显神通。',
};
